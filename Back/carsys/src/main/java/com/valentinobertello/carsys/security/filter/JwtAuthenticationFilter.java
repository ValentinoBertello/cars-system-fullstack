...
import static com.valentinobertello.carsys.security.TokenJwtConfig.*;

/**
 * Filtro personalizado para autenticación (o sea login) con JWT.
 * Se encarga de procesar las credenciales enviadas en el login
 * y generar el token de autenticació. Autentica y genera el token.
 */
public class JwtAuthenticationFilter extends UsernamePasswordAuthenticationFilter {
    ...
    public Authentication attemptAuthentication(HttpServletRequest request, HttpServletResponse response)
        ...
        // Creamos un token de autenticación con las credenciales obtenidas
        ...
        // Por debajo usara el JpaUserDetailsService
